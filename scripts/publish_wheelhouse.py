...
def publish_wheel(wheel: dict, artifact_dir: Path, bucket: str, endpoint_url: str, dry_run: bool) -> None:
...
def main() -> int:
    ...
    if not manifests:
        raise SystemExit(f"No manifest.json files found under {args.artifact_root}")
